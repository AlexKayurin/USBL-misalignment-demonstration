...
fig = plt.figure() 
# Plan
ax_plan = plt.axes([-0.02, 0.19, 0.62, 0.62], aspect=1, frame_on=True, xlim=(-75, 75), ylim=(-75, 75))
plt.title('Plan view', loc='center', fontsize=8)
# Back
ax_back = plt.axes([0.55, 0.47, 0.4, 0.4], aspect=1, xlim=(-100, 100), ylim=(-90, 10))
plt.title('Stern view', fontsize=8)
# Port
ax_port = plt.axes([0.55, 0.157, 0.4, 0.35], aspect=1, xlim=(-100, 100), ylim=(-90, 10))
plt.title('Portside view', fontsize=8)
...
beacon_location = ax_plan.add_patch(plt.Circle((0, 0), 1, fc='b', alpha=0.5)) # beacon location patch
...
# Back
beacon_location = ax_back.add_patch(plt.Circle((0, -50), 1.5, fc='b', alpha=0.5)) # beacon location patch
...
# Port
beacon_location = ax_port.add_patch(plt.Circle((0, -50), 1.5, fc='b', alpha=0.5)) # beacon location patch
...
def Run(val): # Run button
    ...
    gogogo = animation.FuncAnimation(fig, animate_beacon, init_func=anim_init, frames=101, interval=0.2, repeat=False)
...
# Roll slider
ax_roll = plt.axes([0.11, 0.03, 0.6, 0.025])
